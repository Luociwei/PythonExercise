...
from mix.driver.smartgiant.common.ic.at24cxx import AT24C02
...
class DarkBeastBase(SGModuleDriver):
    '''
    ...
    Args:
        ...
        i2c:             instance(I2C),        Class instance of PLI2CBus, which is used to control cat9555,
                                               eeprom and AD5667 sensor.
        pull_up_pin:     instance(GPIO),       Class instance of GPIO, data line pull-up control, Provider mode.
                                               if None creating emulator.
        pull_down_pin:   instance(GPIO),       Class instance of GPIO, data line pull-down control, Consumer mode.
                                               if None creating emulator.
        tx_en_pin:       instance(GPIO),       Class instance of GPIO, UART_TX buffer enable control.
                                               if None creating emulator.
        connect_det_pin: instance(GPIO),       Class instance of GPIO, input pin control, detects whether
                                               the DUT is connected. if None creating emulator.
        removal_det_pin: instance(GPIO),       Class instance of GPIO, Input pin control, detect disconnection
                                               from DUT. if None creating emulator.
        a0_pin:          instance(GPIO),       Class instance of Pin, if None creating emulator.
        a1_pin:          instance(GPIO),       Class instance of Pin, if None creating emulator.
        a2_pin:          instance(GPIO),       Class instance of Pin, if None creating emulator.
        elaod_en_pin:    instance(GPIO),       Class instance of Pin, if None creating emulator.
        eeprom_devaddr:  int,                  Eeprom device address.
        gpio:            instance(GPIO),       Class instance of GPIO, UART RX connect AID to enable or disable.
                                               if None creating emulator.

    '''

    rpc_public_api = ['close', 'open', 'communicate', 'aid_connect_set',
                      'io_set', 'io_get'] + SGModuleDriver.rpc_public_api
    ...
    def __init__(self, firmware_path, pl_uart_drv_ko_file, i2c, pull_up_pin,
                 ...
                 a0_pin, a1_pin, a2_pin, elaod_en_pin, eeprom_devaddr, gpio=None):
        self.path = firmware_path
        self.process = None
        self.pl_uart_drv_ko_file = pl_uart_drv_ko_file

        if(firmware_path != '' and pl_uart_drv_ko_file != '' and i2c is not None and
           ...
           removal_det_pin is not None and connect_det_pin is not None):
            self.eeprom = AT24C02(eeprom_devaddr, i2c)
            self.gpio = gpio
        ...
        if(a0_pin is not None and a1_pin is not None and a2_pin is not None and elaod_en_pin is not None):
            self.a0_pin = a0_pin
            self.a1_pin = a1_pin
            self.a2_pin = a2_pin
    ...
    def post_power_on_init(self, timeout=DarkBeastDef.TIME_OUT):
        '''
        Init DarkBeast module to a know harware state.

        initialize ad5592r channel mode and open DarkBeast process.
    ...
    def reset(self, timeout=DarkBeastDef.TIME_OUT):
        '''
        ...
        while True:
            try:
                ...
                if time.time() - start_time > timeout:
                    raise DarkBeastException("Timeout: {}".format(e.message))

    def pre_power_down(self, timeout=DarkBeastDef.TIME_OUT):
        '''
    ...
    def io_set(self, io_name, level):
        ...
        Args:
            io_name:  string, io_name can be found in the table below.
...
class DarkBeast(DarkBeastBase):
    ...
    Args:
        ...
        i2c:             instance(I2C),        Class instance of PLI2CBus, which is used to control cat9555,
                                               eeprom and AD5667 sensor.
        gpio:            instance(GPIO),       Class instance of PLGPIO, UART RX connect AID to enable or disable.
        pull_up_pin:     instance(GPIO),       Class instance of GPIO, data line pull-up control, Provider mode.
        pull_down_pin:   instance(GPIO),       Class instance of GPIO, data line pull-down control, Consumer mode.
        tx_en_pin:       instance(GPIO),       Class instance of GPIO, UART_TX buffer enable control.
        connect_det_pin: instance(GPIO),       Class instance of GPIO, input pin control, detects whether
        ...
        removal_det_pin: instance(GPIO),       Class instance of GPIO, Input pin control, detect disconnection
                                               from DUT.
        a0_pin:          instance(GPIO),       Class instance of Pin.
        a1_pin:          instance(GPIO),       Class instance of Pin.
        a2_pin:          instance(GPIO),       Class instance of Pin.
        elaod_en_pin:    instance(GPIO),       Class instance of Pin.
        gpio:            instance(GPIO),       Class instance of GPIO, UART RX connect AID to enable or disable.
                                               if None creating emulator.
    ...
    Examples:
        ...
        darkbeast = DarkBeast(firmware_path, pl_uart_drv_ko_file, i2c, gpio, pull_up_pin,
                              pull_down_pin, tx_en_pin, removal_det_pin, connect_det_pin,
                              a0_pin, a1_pin, a2_pin, elaod_en_pin)
    ...
    def __init__(self, firmware_path, pl_uart_drv_ko_file, i2c, pull_up_pin,
                 pull_down_pin, tx_en_pin, removal_det_pin, connect_det_pin,
                 a0_pin, a1_pin, a2_pin, elaod_en_pin, gpio=None):
