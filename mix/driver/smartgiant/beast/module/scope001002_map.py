# -*- coding: utf-8 -*-
from mix.driver.smartgiant.beast.module.scope001001_map import BeastBase
...
class Scope001002(BeastBase):
    ...
    Args:
        ...
        range_ctrl_pin:   instance(GPIO),            used to control Scope001002 range.
    ...
    Examples:
        # use non-aggregated IP
            ...
            scope001002 = Scope001002(i2c,range_ctrl_pin, dcac_ctrl_pin, output_ctrl_pin, pl_signal_meter)
        ...
        # use MIXDAQT2 aggregated IP, not use MIXDAQT2 inside gpio
            ...
            scope001002 = Scope001002(i2c,range_ctrl_pin, dcac_ctrl_pin, output_ctrl_pin, None, mix_daqt2)
        ...
        # if GPIO expander is behind a i2c-mux, set i2c-mux channel then call
            scope001002.post_power_on_init()
    ...
    def __init__(self, i2c, range_ctrl_pin=None, dcac_ctrl_pin=None, output_ctrl_pin=None, pl_signal_meter=None,
                 ipcore=None):
        super(Scope001002, self).__init__(i2c, range_ctrl_pin, dcac_ctrl_pin, output_ctrl_pin, pl_signal_meter, ipcore,
