...
class Warlock(MIXBoard):
    ...
    compatible = ["GQQ-MIK002001-000"]

    rpc_public_api = ['module_init', 'enable_upload', 'disable_upload', 'measure', 'xtalk_measure',
                      ...
                      'start_record_data', 'stop_record_data'] + MIXBoard.rpc_public_api
    ...
    def module_init(self):
        '''
        Warlock init module, will reset adc and i2s module.
    ...
    def _audio_channel_select(self, channel):
        ...
        Examples:
            starlord._audio_channel_select('left')
