...
from mix.driver.smartgiant.blade.module.scope007001_map import Scope007001
...
class BladeDebuger(cmd.Cmd):
    ...
    def do_post_power_on_init(self, line):
        ...
        self.blade.post_power_on_init(eval(line))
        print("Done.")

    @handle_errors
    def do_reset(self, line):
        '''reset timeout'''
        self.blade.reset(eval(line))
        print("Done.")

    @handle_errors
    def do_pre_power_down(self, line):
        '''pre_power_down timeout'''
        self.blade.pre_power_down(eval(line))
        print("Done.")

    @handle_errors
    def do_get_driver_version(self, line):
        '''get_driver_version'''
        result = self.blade.get_driver_version()
        print("Result:")
        print(result)
...
def create_blade_dbg(i2c_dev_name,
    ...
    adc_ctrl_pin_0 = GPIO(91)
    adc_ctrl_pin_1 = GPIO(92)
    ...
    blade_dbg.blade = Scope007001(i2c=i2c,
                                  adc=ad7608,
                                  xadc=xadc,
