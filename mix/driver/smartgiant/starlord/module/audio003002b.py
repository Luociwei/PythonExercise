# -*- coding: utf-8 -*-
import bisect
from mix.driver.smartgiant.starlord.module.starlord import StarLord, StarLordDef
...
class Audio003002B(StarLord):
    ...
    def measure(self, channel, bandwidth_hz, harmonic_count,
        ...
        Args:
            ...
            sampling_rate:   int, default 192000, unit Hz, ADC sampling rate.
