...
from mix.driver.smartgiant.beast.module.scope001001_map import Beast
...
class BeastDebuger(cmd.Cmd):
    ...
    def do_post_power_on_init(self, line):
        ...
        self.beast.post_power_on_init(eval(line))
        print("Done.")

    @handle_errors
    def do_reset(self, line):
        '''reset timeout_s'''
        self.beast.reset(eval(line))
        print("Done.")

    @handle_errors
    def do_get_driver_version(self, line):
        '''get_driver_version'''
        self.beast.get_driver_version()
        print("Done.")
...
if __name__ == '__main__':
    ...
    beast_dbg = create_beast_dbg(args.signal_meter, args.daqt2, args.i2c)
