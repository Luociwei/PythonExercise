...
class StarLord(MIXBoard):
    ...
    rpc_public_api = ['module_init', 'enable_upload', 'disable_upload', 'measure',
                      ...
                      'enable_lna_upload', 'disable_lna_upload', 'config_lna_scope'] + MIXBoard.rpc_public_api
    ...
    def __init__(self, i2c, ipcore=None, range_table=starlord_table):
        ...
        if ipcore:
            ...
            self.ad7175 = MIXAd7175SGEmulator('mix_ad7175_sg_emulator', StarLordDef.EMULATOR_REG_SIZE)
            self.i2s_ch_select = [Pin(None, StarLordDef.I2S_CH_SELECT_2), Pin(None, StarLordDef.I2S_CH_SELECT_3)]
            self.fft_source_select = Pin(None, StarLordDef.FFT_SOURCE_SELECT)
            self.ad7175_upload_select = Pin(None, StarLordDef.AD7175_TO_FFT_OR_NOT)

        super(StarLord, self).__init__(self.eeprom, self.nct75, cal_table={}, range_table=range_table)
