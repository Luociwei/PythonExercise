...
ALLOWED_FOLDER_GET_FILE = ['~', '/tmp', '/var/log/rpc_log','/mix/addon/dut_firmware/ch1','/mix/addon/dut_firmware/ch2','/mix/addon/dut_firmware/ch3','/mix/addon/dut_firmware/ch4']
